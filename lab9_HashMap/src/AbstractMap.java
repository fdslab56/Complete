...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    protected static class MapEntry<K, V> implements Entry<K, V> {
        ...
        /**
         * 6
         * Constructs an instance of the MapEntry with the specified key and
         * value.
         *
    ...
    /**
     * This private class provides an implementation of the Iterator interface
     * for keys in the map.
     */
    ...
    /**
     * This private class provides an implementation of the Iterable interface
     * for keys in the map.
     */
