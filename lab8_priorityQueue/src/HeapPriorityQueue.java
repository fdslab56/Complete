...
public class HeapPriorityQueue<K, V> extends AbstractPriorityQueue<K, V> {
    ...
    /**
     * Constructs an empty heap priority queue using the provided comparator for key
     * comparison.
     *
    ...
    /**
     * Displays all entries in the priority queue.
     * Each entry is printed in the format "Key: key, Value: value".
     */
